  ...
  return (
    <>
      ...
      <section className="py-15 w-full flex flex-col justify-center min-h-[80vh] items-center text-center gap-12">
        <div className="px-4 container flex flex-col items-center gap-7">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link href="#">
              <Button fill="blue" text="Message Chatbot" />
            </Link>
            <Link href="#">
              <Button fill="white" text="WhatsApp Chat" />
            </Link>
          </div>
        </div>
        <div className="flex flex-wrap justify-center relative pt-16 max-w-[90%] mx-auto">
          ...
          <div className="absolute -bottom-6">
            ...
            >
              <path
                d="M287 9.5C287 14.7467 222.753 19 143.5 19C64.2471 19 0 14.7467 0 9.5C0 4.25329 64.2471 0 143.5 0C222.753 0 287 4.25329 287 9.5Z"
                fill="#EBEBEB"
              />
            </svg>
          </div>
        ...
        <div className="container">
          ...
          <div className="flex flex-wrap justify-center xl:justify-between gap-28 xl:gap-10">
            ...
            <div className="bg-[#F9F9FF] hover:bg-main text-black hover:text-white transition-all duration-300 ease-in-out w-[400px] h-[450px] rounded-2xl p-8 flex flex-col justify-center items-center gap-6 relative">
              ...
              <p className="text-[16px] max-w-[300px]">
                Start a conversation with our WhatsApp chatbot—just a few clicks
                and you’re all set!
              </p>
              <div className="absolute -top-20 h-[140px] w-[140px] flex justify-center items-center bg-white rounded-full">
                <svg
            ...
            <div className="bg-[#F9F9FF] hover:bg-main text-black hover:text-white transition-all duration-300 ease-in-out w-[400px] h-[450px] rounded-2xl p-8 flex flex-col justify-center items-center gap-6 relative">
              ...
              <p className="text-[16px] max-w-[300px]">
                Enjoy a more efficient commute, with real-time insights to keep
                you ahead of the traffic.
              </p>
              <div className="absolute -top-20 h-[140px] w-[140px] flex justify-center items-center bg-white rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="w-full flex justify-center px-10 relative -bottom-12">
        <div className="flex flex-wrap justify-center lg:justify-between text-center lg:text-start items-center container bg-main gap-10 px-8 lg:px-28 py-16 text-white rounded-[40px]">
          <div className="flex flex-col gap-6 items-center lg:items-start">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Link href="#">
                <Button fill="white" text="Message Chatbot" />
              </Link>
              <Link href="#">
                <Button fill="white" text="WhatsApp Chat" />
              </Link>
