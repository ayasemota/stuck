...
export default function Chat() {
    ...
    return (
        <>
            <button
                onClick={toggleChat}
                className="fixed bottom-10 right-10 bg-[#3F4AE4] hover:bg-[#1a4bff] hover:scale-105 p-3 h-[55px] w-[55px] flex items-center justify-center rounded-full shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300 z-50"
            >
                {isOpen ? (
            ...
            {isOpen && (
                ...
                >
                    <div className="px-6 py-5 bg-neutral-50 flex justify-between items-center">
                        <div className="w-[10%]">
