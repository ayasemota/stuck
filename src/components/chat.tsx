        ...
        <>
            ...
            {isOpen && (
                ...
                >
                    ...
                    {isFullScreen && (
                        <div className="hidden lg:flex flex-col items-center justify-between border-r text-black w-[400px] min-w-[20vw] py-20 border-l border-[#b7b7b7]">
